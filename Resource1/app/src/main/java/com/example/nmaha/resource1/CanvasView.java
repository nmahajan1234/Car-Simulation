package com.example.nmaha.resource1;
        ...
        import static com.example.nmaha.resource1.MainActivity.aflag;

        import static com.example.nmaha.resource1.MainActivity.pointStartCar1;
        import static com.example.nmaha.resource1.MainActivity.pointStartCar2;
        import static com.example.nmaha.resource1.MainActivity.pointStartCar3;
        import static com.example.nmaha.resource1.MainActivity.prevPointStartCar1;
        import static com.example.nmaha.resource1.MainActivity.pointMiddleCar1;
        import static com.example.nmaha.resource1.MainActivity.pointMiddleCar2;
        import static com.example.nmaha.resource1.MainActivity.pointMiddleCar3;
        import static com.example.nmaha.resource1.MainActivity.prevPointMiddleCar1;
        import static com.example.nmaha.resource1.MainActivity.pointEndCar1;
        import static com.example.nmaha.resource1.MainActivity.pointEndCar2;
        import static com.example.nmaha.resource1.MainActivity.pointEndCar3;
        import static com.example.nmaha.resource1.MainActivity.prevPointEndCar1;

        import static com.example.nmaha.resource1.MainActivity.context;
        import static com.example.nmaha.resource1.MainActivity.raceMode;
        import static com.example.nmaha.resource1.MainActivity.cityMode;
        import static com.example.nmaha.resource1.MainActivity.toast1;
        import static com.example.nmaha.resource1.MainActivity.toast2;
...
*/
        ...
        if( (pointMiddleCar1[0] < -520) ){
            pointStartCar1[0] = -510;
            pointMiddleCar1[0] = -510;
            pointEndCar1[0] = -510;
            pointStartCar1[1] = prevPointMiddleCar1[1] - 10;
            pointMiddleCar1[1] = prevPointMiddleCar1[1] ;
            pointEndCar1[1] = prevPointMiddleCar1[1] + 10;
        }
/*
...
*/
        else if( (pointMiddleCar1[1] > 675) ){
            pointStartCar1[1] = 665;
            pointMiddleCar1[1] = 665 ;
            pointEndCar1[1] = 665;
            pointStartCar1[0] = prevPointMiddleCar1[0] - 10;
            pointMiddleCar1[0] = prevPointMiddleCar1[0];
            pointEndCar1[0] = prevPointMiddleCar1[0] + 10;
        }
/*
...
*/
        else if( (pointMiddleCar1[1] < -420) ){
            pointStartCar1[1] = -410;
            pointMiddleCar1[1] = -410;
            pointEndCar1[1] = -410;
            pointStartCar1[0] = prevPointMiddleCar1[0] + 10;
            pointMiddleCar1[0] = prevPointMiddleCar1[0];
            pointEndCar1[0] = prevPointMiddleCar1[0] - 10;
...
*/
        ...
        if(raceMode) {
            ...
            if (Math.abs (pointMiddleCar1[0] - pointMiddleCar2[0]) <= 30 && Math.abs (pointMiddleCar1[1] - pointMiddleCar2[1]) <= 30) {
                if (toast_flag2) {
            ...
            if (Math.abs (pointMiddleCar1[0] - pointMiddleCar3[0]) <= 30 && Math.abs (pointMiddleCar1[1] - pointMiddleCar3[1]) <= 30) {
                if (toast_flag1) {
            ...
            if (Math.abs (pointMiddleCar1[0] - pointMiddleCar2[0]) < 50 && Math.abs (pointMiddleCar1[1] - pointMiddleCar2[1]) < 50) {
                if (toast_flag2) {
            ...
            if (Math.abs (pointMiddleCar1[0] - pointMiddleCar3[0]) < 50 && Math.abs (pointMiddleCar1[1] - pointMiddleCar3[1]) < 50) {
                if (toast_flag1) {
        ...
        if ( (pointMiddleCar1[0] >= -520) && (pointMiddleCar1[0] <= 520)
//                && (pointMiddleCar3[0] <= -340) && (pointMiddleCar3[0] >= 340)
                && (pointMiddleCar1[1] <= 675) && (pointMiddleCar1[1] >= -420)
...
//            Log.d("velocity", String.valueOf(velocity));
            ...
            if (step > 0) {
                ...
                if (pointStartCar1[0] == pointEndCar1[0]) {
                    //move along Y
                    if (pointStartCar1[1] < pointEndCar1[1]) {
                        //move up
//                        Log.d (TAG, "move up on Y");
                        pointStartCar1[1] = pointStartCar1[1] - (translateStep);
                        pointMiddleCar1[1] = pointMiddleCar1[1] - (translateStep);
                        pointEndCar1[1] = pointEndCar1[1] - (translateStep);

                        //New 12/03/2017
                        prevPointStartCar1[1] = pointStartCar1[1];
                        prevPointMiddleCar1[1] = pointMiddleCar1[1];
                        prevPointEndCar1[1] = pointEndCar1[1];
                ...
                if (pointStartCar1[1] == pointEndCar1[1]) {
                    ...
                    if (pointStartCar1[0] < pointEndCar1[0]) {
                        ...
                        pointStartCar1[0] = pointStartCar1[0] - translateStep;
                        pointMiddleCar1[0] = pointMiddleCar1[0] - translateStep;
                        pointEndCar1[0] = pointEndCar1[0] - translateStep;

                        //New 12/03/2017
                        prevPointStartCar1[0] = pointStartCar1[0];
                        prevPointMiddleCar1[0] = pointMiddleCar1[0];
                        prevPointEndCar1[0] = pointEndCar1[0];
                ...
                if (!translatedFlag) {
                    ...
                    double slope = slopeCalculator (pointEndCar1[0], pointEndCar1[1], pointStartCar1[0], pointStartCar1[1]);
                    ...
                    pointStartCar1[1] = slope * (pointStartCar1[0] + stepForLine) - slope * pointEndCar1[0] + pointEndCar1[1];
                    pointStartCar1[0] = pointStartCar1[0] + stepForLine;

                    pointMiddleCar1[1] = slope * (pointMiddleCar1[0] + stepForLine) - slope * pointEndCar1[0] + pointEndCar1[1];
                    pointMiddleCar1[0] = pointMiddleCar1[0] + stepForLine;

                    pointEndCar1[1] = slope * (pointEndCar1[0] + stepForLine) - slope * pointEndCar1[0] + pointEndCar1[1];
                    pointEndCar1[0] = pointEndCar1[0] + stepForLine;
...
//        Log.d("theta",""+dtheta);
        ...
        rotationCoordstoBePassed[0] = pointStartCar1[0] - pointMiddleCar1[0];
        rotationCoordstoBePassed[1] = pointStartCar1[1] - pointMiddleCar1[1];
        rotatedCoords= rotationCoords(rotationCoordstoBePassed,dtheta,direction);

        pointStartCar1[0] =  pointMiddleCar1[0] + rotatedCoords[0];
        pointStartCar1[1]=  pointMiddleCar1[1] + rotatedCoords[1];



        rotationCoordstoBePassed[0] = pointEndCar1[0] - pointMiddleCar1[0];
        rotationCoordstoBePassed[1] = pointEndCar1[1] - pointMiddleCar1[1];
        rotatedCoords = rotationCoords(rotationCoordstoBePassed,dtheta,direction);
        pointEndCar1[0] =  pointMiddleCar1[0]+rotatedCoords[0];
        pointEndCar1[1]=   pointMiddleCar1[1]+rotatedCoords[1];
...
//        canvas.drawText(String.format( "Engine RPM: %.0f rev/s.", Math.abs (velocity/0.1)),600,380,mPaintText);
    ...
    public void limitCheckerForCar (){
        if(Math.abs(pointStartCar1[0]) > (displayMetrics.widthPixels/2)-5 || Math.abs(pointStartCar1[1]) > (displayMetrics.heightPixels/4)-5){
            pointLimitsForCar =true;

        }
        if(Math.abs(pointEndCar1[0]) > (displayMetrics.widthPixels/2)-5 || Math.abs(pointEndCar1[1]) > (displayMetrics.heightPixels/4)-5){
            pointLimitsForCar =true;

        }
        if(Math.abs(pointMiddleCar1[0]) > (displayMetrics.widthPixels/2)-5 || Math.abs(pointMiddleCar1[1]) > (displayMetrics.heightPixels/4)-5){
            pointLimitsForCar =true;
