...
public class MainActivity extends Activity {
    ...
    public static double[] prevPointStartCar1 = new double[2];
    public static double[] prevPointEndCar1 = new double[2];
    public static double[] prevPointMiddleCar1 = new double[2];
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    pointStartCar2[0] = Double.parseDouble(carData[0]);
                    pointStartCar2[1] = Double.parseDouble(carData[1]);
                    pointMiddleCar2[0] = Double.parseDouble(carData[2]);
                    pointMiddleCar2[1] = Double.parseDouble(carData[3]);
                    pointEndCar2[0] = Double.parseDouble(carData[4]);
                    pointEndCar2[1] = Double.parseDouble(carData[5]);

                    Log.d("Data2Pos : ", carData[0] + carData[1] + carData[2]+carData[3] + carData[4] + carData[5]);

                    pointStartCar3[0] = Double.parseDouble(carData[6]);
                    pointStartCar3[1] = Double.parseDouble(carData[7]);
                    pointMiddleCar3[0] = Double.parseDouble(carData[8]);
                    pointMiddleCar3[1] = Double.parseDouble(carData[9]);
                    pointEndCar3[0] = Double.parseDouble(carData[10]);
                    pointEndCar3[1] = Double.parseDouble(carData[11]);
