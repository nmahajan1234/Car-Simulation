...
public class MyClientTask extends AsyncTask<Void, Void, Void> {
    ...
    MyClientTask() {
        ...
        start[0] = pointStartCar1[0];
        Log.d("start",String.valueOf(pointStartCar1[0]));
        start[1] = pointStartCar1[1];
        middle[0] = pointMiddleCar1[0];
        middle[1] = pointMiddleCar1[1];
        end[0] = pointEndCar1[0];
        end[1] = pointEndCar1[1];
...
//            is = new BufferedReader(new InputStreamReader(socket.getInputStream()));
            ...
            InetAddress hostAddress = InetAddress.getByName("192.168.1.131"); // Enter Raspberry pi specific IP
