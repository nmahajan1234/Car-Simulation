...
public class MyClientTask extends AsyncTask<Void, Void, Void> {
    ...
    MyClientTask() {
        ...
        start[0] = pointStartCar2[0];
        Log.d("start",String.valueOf(pointStartCar2[0]));
        start[1] = pointStartCar2[1];
        middle[0] = pointMiddleCar2[0];
        middle[1] = pointMiddleCar2[1];
        end[0] = pointEndCar2[0];
        end[1] = pointEndCar2[1];
...
//            is = new BufferedReader(new InputStreamReader(socket.getInputStream()));
            ...
            InetAddress hostAddress = InetAddress.getByName("192.168.1.131"); //Set your Raspberry pi IP
