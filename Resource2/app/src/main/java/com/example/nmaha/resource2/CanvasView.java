package com.example.nmaha.resource2;
...
//import android.animation.ValueAnimator;
        ...
        import static com.example.nmaha.resource2.MainActivity.aflag;

        import static com.example.nmaha.resource2.MainActivity.pointStartCar1;
        import static com.example.nmaha.resource2.MainActivity.pointStartCar2;
        import static com.example.nmaha.resource2.MainActivity.pointStartCar3;
        import static com.example.nmaha.resource2.MainActivity.prevPointStartCar2;
        import static com.example.nmaha.resource2.MainActivity.pointMiddleCar1;
        import static com.example.nmaha.resource2.MainActivity.pointMiddleCar2;
        import static com.example.nmaha.resource2.MainActivity.pointMiddleCar3;
        import static com.example.nmaha.resource2.MainActivity.prevPointMiddleCar2;
        import static com.example.nmaha.resource2.MainActivity.pointEndCar1;
        import static com.example.nmaha.resource2.MainActivity.pointEndCar2;
        import static com.example.nmaha.resource2.MainActivity.pointEndCar3;
        import static com.example.nmaha.resource2.MainActivity.prevPointEndCar2;

        import static com.example.nmaha.resource2.MainActivity.context;
        import static com.example.nmaha.resource2.MainActivity.raceMode;
        import static com.example.nmaha.resource2.MainActivity.cityMode;
        import static com.example.nmaha.resource2.MainActivity.toast1;
        import static com.example.nmaha.resource2.MainActivity.toast2;
...
*/
        ...
        if( (pointMiddleCar2[0] < -520) ){
            pointStartCar2[0] = -510;
            pointMiddleCar2[0] = -510;
            pointEndCar2[0] = -510;
            pointStartCar2[1] = prevPointMiddleCar2[1] - 10;
            pointMiddleCar2[1] = prevPointMiddleCar2[1] ;
            pointEndCar2[1] = prevPointMiddleCar2[1] + 10;
        }
/*
...
*/
        else if( (pointMiddleCar2[1] > 675) ){
            pointStartCar2[1] = 665;
            pointMiddleCar2[1] = 665 ;
            pointEndCar2[1] = 665;
            pointStartCar2[0] = prevPointMiddleCar2[0] - 10;
            pointMiddleCar2[0] = prevPointMiddleCar2[0];
            pointEndCar2[0] = prevPointMiddleCar2[0] + 10;
        }
/*
...
*/
        else if( (pointMiddleCar2[1] < -420) ){
            pointStartCar2[1] = -410;
            pointMiddleCar2[1] = -410;
            pointEndCar2[1] = -410;
            pointStartCar2[0] = prevPointMiddleCar2[0] + 10;
            pointMiddleCar2[0] = prevPointMiddleCar2[0];
            pointEndCar2[0] = prevPointMiddleCar2[0] - 10;
...
*/
        ...
        if(raceMode) {
            ...
            if (Math.abs (pointMiddleCar2[0] - pointMiddleCar3[0]) <= 30 && Math.abs (pointMiddleCar2[1] - pointMiddleCar3[1]) <= 30) {
                if (toast_flag2) {
            ...
            if (Math.abs (pointMiddleCar2[0] - pointMiddleCar1[0]) <= 30 && Math.abs (pointMiddleCar2[1] - pointMiddleCar1[1]) <= 30) {
                if (toast_flag1) {
            ...
            if (Math.abs (pointMiddleCar2[0] - pointMiddleCar3[0]) < 50 && Math.abs (pointMiddleCar2[1] - pointMiddleCar3[1]) < 50) {
                if (toast_flag2) {
            ...
            if (Math.abs (pointMiddleCar2[0] - pointMiddleCar1[0]) < 50 && Math.abs (pointMiddleCar2[1] - pointMiddleCar1[1]) < 50) {
                if (toast_flag1) {
        ...
        if ( (pointMiddleCar2[0] >= -520) && (pointMiddleCar2[0] <= 520)
//                && (pointMiddleCar3[0] <= -340) && (pointMiddleCar3[0] >= 340)
                && (pointMiddleCar2[1] <= 675) && (pointMiddleCar2[1] >= -420)
...
//            Log.d("velocity", String.valueOf(velocity));
            ...
            if (step > 0) {
                ...
                if (pointStartCar2[0] == pointEndCar2[0]) {
                    //move along Y
                    if (pointStartCar2[1] < pointEndCar2[1]) {
                        //move up
//                        Log.d (TAG, "move up on Y");
                        pointStartCar2[1] = pointStartCar2[1] - (translateStep);
                        pointMiddleCar2[1] = pointMiddleCar2[1] - (translateStep);
                        pointEndCar2[1] = pointEndCar2[1] - (translateStep);

                        //New 12/03/2017
                        prevPointStartCar2[1] = pointStartCar2[1];
                        prevPointMiddleCar2[1] = pointMiddleCar2[1];
                        prevPointEndCar2[1] = pointEndCar2[1];
                ...
                if (pointStartCar2[1] == pointEndCar2[1]) {
                    ...
                    if (pointStartCar2[0] < pointEndCar2[0]) {
                        ...
                        pointStartCar2[0] = pointStartCar2[0] - translateStep;
                        pointMiddleCar2[0] = pointMiddleCar2[0] - translateStep;
                        pointEndCar2[0] = pointEndCar2[0] - translateStep;

                        //New 12/03/2017
                        prevPointStartCar2[0] = pointStartCar2[0];
                        prevPointMiddleCar2[0] = pointMiddleCar2[0];
                        prevPointEndCar2[0] = pointEndCar2[0];
                ...
                if (!translatedFlag) {
                    ...
                    double slope = slopeCalculator (pointEndCar2[0], pointEndCar2[1], pointStartCar2[0], pointStartCar2[1]);
                    ...
                    pointStartCar2[1] = slope * (pointStartCar2[0] + stepForLine) - slope * pointEndCar2[0] + pointEndCar2[1];
                    pointStartCar2[0] = pointStartCar2[0] + stepForLine;

                    pointMiddleCar2[1] = slope * (pointMiddleCar2[0] + stepForLine) - slope * pointEndCar2[0] + pointEndCar2[1];
                    pointMiddleCar2[0] = pointMiddleCar2[0] + stepForLine;

                    pointEndCar2[1] = slope * (pointEndCar2[0] + stepForLine) - slope * pointEndCar2[0] + pointEndCar2[1];
                    pointEndCar2[0] = pointEndCar2[0] + stepForLine;
...
//        Log.d("theta",""+dtheta);
        ...
        rotationCoordstoBePassed[0] = pointStartCar2[0] - pointMiddleCar2[0];
        rotationCoordstoBePassed[1] = pointStartCar2[1] - pointMiddleCar2[1];
        rotatedCoords= rotationCoords(rotationCoordstoBePassed,dtheta,direction);

        pointStartCar2[0] =  pointMiddleCar2[0] + rotatedCoords[0];
        pointStartCar2[1]=  pointMiddleCar2[1] + rotatedCoords[1];



        rotationCoordstoBePassed[0] = pointEndCar2[0] - pointMiddleCar2[0];
        rotationCoordstoBePassed[1] = pointEndCar2[1] - pointMiddleCar2[1];
        rotatedCoords = rotationCoords(rotationCoordstoBePassed,dtheta,direction);
        pointEndCar2[0] =  pointMiddleCar2[0]+rotatedCoords[0];
        pointEndCar2[1]=   pointMiddleCar2[1]+rotatedCoords[1];
...
//        canvas.drawText(String.format( "Engine RPM: %.0f rev/s.", Math.abs (velocity/0.1)),600,380,mPaintText);
    ...
    public void limitCheckerForCar (){
        if(Math.abs(pointStartCar2[0]) > (displayMetrics.widthPixels/2)-5 || Math.abs(pointStartCar2[1]) > (displayMetrics.heightPixels/4)-5){
            pointLimitsForCar =true;

        }
        if(Math.abs(pointEndCar2[0]) > (displayMetrics.widthPixels/2)-5 || Math.abs(pointEndCar2[1]) > (displayMetrics.heightPixels/4)-5){
            pointLimitsForCar =true;

        }
        if(Math.abs(pointMiddleCar2[0]) > (displayMetrics.widthPixels/2)-5 || Math.abs(pointMiddleCar2[1]) > (displayMetrics.heightPixels/4)-5){
            pointLimitsForCar =true;
