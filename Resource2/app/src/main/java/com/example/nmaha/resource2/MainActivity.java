...
public class MainActivity extends Activity {
    ...
    public static double[] prevPointStartCar2 = new double[2];
    public static double[] prevPointEndCar2 = new double[2];
    public static double[] prevPointMiddleCar2 = new double[2];
